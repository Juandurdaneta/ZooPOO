...
public class opcionReptil {
	...
	private void initialize() {
		...
		JLabel ventanam = new JLabel("Ventana para registrar un Reptil");
	...
	private void IngresarActionPerformed(java.awt.event.ActionEvent evnt) {//METODO PARA AÑADIR LO INGRESADO A LA BASE DE DATOS
		...
		try {
			...
			r.setGenero(Genero.getText());
			r.setEdad(Edad.getText());
			...
			String sql = "INSERT INTO reptil (NombreAnimal,Genero,Edad"+"VALUES (?,?,?)";
			
			PreparedStatement pstmt = conn.prepareStatement(sql);
			pstmt.setString(1, r.getNombre());
			pstmt.setString(2, r.getGenero());
			pstmt.setString(3, r.getEdad());
